...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      ...
      <ul className={nav ? ' fixed z-30  left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-primary backdrop-blur-[2px] bg-opacity-20 ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
