          ...
          <div className='w-full bg-white backdrop-blur-[2px] bg-opacity-30 rounded-lg p-4'>
              <h1 className='text-gray-300 font-bold text-2xl'>Publish a ride</h1>
                <div className='flex justify-center items-center p-4 gap-x-8'>
                  <div className='bg-gray-300 w-[20%] p-1 mt-2 rounded-lg '>
                    <DragAndDrop />
                  </div>
            ...
            <div className='flex justify-center gap-2'>
              <input type="text" className='p-2 w-[25%] outline-none bg-white backdrop-blur-[3px] bg-opacity-30 rounded-2xl placeholder-white focus:border focus:border-primary '
              placeholder='Date Of Ride'
              required
              value={dob===null?"":dob}/>
              <input type="date" name="" id="" className='p-2 w-[6%] outline-none bg-white backdrop-blur-[3px] bg-opacity-30 rounded-2xl placeholder-white focus:border focus:border-primary  text-transparent' onChange={(e)=>setDOB(e.target.value)}/>
            </div>
